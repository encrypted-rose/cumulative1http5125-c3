...
namespace cumulative1http5125.Controllers
{
...

    {
        ...
        //Update Teacher
        /// <summary>
        /// Receive some teacher data and the teacher Id and update the teacher data in the database that matches with the Id.
        /// </summary>
        /// <returns>
        /// </returns>
        /// <example>
        ///> curl -d @teacher.json -H "Content-Type: application/json" http://localhost:54021/api/teacherdata/updateTeacher/11
        /// </example>
        /// <example>
